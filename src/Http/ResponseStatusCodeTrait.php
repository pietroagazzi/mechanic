 ...
 * @package Pietroagazzi\Mechanic\Http
 */
trait ResponseStatusCodeTrait
{
    ...
    /**
     * Status codes translation table (RFC2616).
    ...
    /**
     * Gets the status text for the given status code.
     * @param int $status
     * @return string
     */
    public static function text(int $status): string
    {
        if (!array_key_exists($status, static::StatusTexts)) {
            throw new InvalidArgumentException("Status code {$status} not found");
        }
